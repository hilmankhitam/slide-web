    ...
    >
      ...
      >
        ...
        {label === "PRO" ? (
            ...
            <p className="font-bold mt-2 text-3xl text-text-secondary">Standard</p>
        )}
        {label === "PRO" ? (
            <p className="mb-2">
        ...
        {landing ? (
          <Button className={cn("rounded-full mt-5", label === "PRO" ? "bg-gradient-to-r text-white from-indigo-500 via-purple-500 to-pink-500" : "bg-background-80 text-white hover:text-background-80")}>
            {label === current ? "Get Started" : current === "PRO" ? "Free" : "Get Started"}
          </Button>
        ): (
          <Button className="rounded-full mt-5 bg-background-80 text-white hover:textbackground-80" disabled={label === current}>
