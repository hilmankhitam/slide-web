import { TinyInstagram } from "@/icons";
...
export const AUTOMATION_TRIGGERS: AutomationsTriggerProps[] = [
    {
      ...
      icon: <TinyInstagram />,
      description: "Select if you want automate comments on your post.",
      type: "COMMENT",
    },
    {
      id: v4(),
      ...
      icon: <TinyInstagram />,
      description: "Select if you want automate DMs on your profile.",
      type: "DM",
    },
  ];
